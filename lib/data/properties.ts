export const PROPERTY_DATA = {
  '1': {
    ...
    reviewCount: 127,
    price: 50,
    description: "Spacious single family home with high-speed internet, full kitchen and workspace. Perfect for nurses, graduate students, service members, and other professionals.",
    bedrooms: 3,
    bathrooms: 2,
    sqft: 1931,
    proximityBadges: [
  ...
  '3': {
    ...
    reviewCount: 156,
    price: 50,
    description: "Quiet neighborhood perfect for pediatric nurses, visiting professors, military families, and young professionals. Family-friendly area with nearby parks and cafes.",
    bedrooms: 3,
    bathrooms: 2,
    sqft: 2218,
    proximityBadges: [
