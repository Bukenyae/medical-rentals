...
type HomeClientProps = {
  initialProperties: PublishedPropertyRecord[];
  initialError: string | null;
};

export default function HomeClient({ initialProperties, initialError }: HomeClientProps) {
  ...
  const [dbProperties, setDbProperties] = useState<PublishedPropertyRecord[]>(initialProperties);
  const [propertiesTried, setPropertiesTried] = useState(true);
  const [propertiesError, setPropertiesError] = useState<string | null>(initialError);
