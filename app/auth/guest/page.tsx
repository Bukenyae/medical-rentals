...
export default function GuestAuthPage() {
  ...
  useEffect(() => {
    // If already signed in, send to guest portal
  ...
  const onSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Redirect based on role; default to guest portal
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-lg border border-gray-200 p-6">
        <h1 className="text-xl font-semibold text-gray-900 mb-2">Guest Sign In</h1>
        ...
        <div className="text-xs text-gray-500 mt-6 space-y-2">
          ...
          <div>
            Prefer to manage listings? <a className="underline" href="/auth/host">Host sign-in</a>
          </div>
        </div>
      </div>
    </div>
