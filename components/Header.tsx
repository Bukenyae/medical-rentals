...
export default function Header({
  ...
  useEffect(() => {
    if (!isScrolled) {
      setIsMobileStickySearchOpen(false);
    }
  }, [isScrolled]);
  ...
  return (
    <>
      ...
      <div
        className={`fixed top-0 left-0 right-0 z-[70] bg-white backdrop-blur-0 transition-transform duration-300 ${
          isScrolled ? 'translate-y-0' : '-translate-y-full'
        }`}
      >
        <div className="bg-white shadow-lg border-b border-gray-200">
          <div className="max-w-7xl mx-auto px-2 sm:px-4 lg:px-6">
            <div className="hidden sm:flex items-center justify-between py-3 sm:py-4 gap-2 sm:gap-4">
