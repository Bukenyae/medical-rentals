...
export default function Header({
  ...
  return (
    <>
      ...
      <header className={`absolute top-0 left-0 right-0 ${isScrolled ? 'opacity-0 pointer-events-none' : 'opacity-100'} transition-opacity duration-300 z-20 bg-transparent`}>
